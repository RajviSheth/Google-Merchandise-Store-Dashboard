...
-- Ans. Total 13% of our users use Android Operating System


-- 3.	ARE MOST OF YOUR USERS ACCESSING THE SITE FROM A MOBILE DEVICE?
-- Ans. Most of the users are not accessing the site via a mobile device!
...
-- Ans.  - Demonstrate the importance of data-driven decision making
-- - Encourage exploration and experimentation
-- - Google's merchandise store dataset, can help businesses gain a deep
-- - understanding of their website and customer data
